...
static const NSString *WOCrashSeparatorWithFlagStart = @">>>>>>>>>>>>>>>>>>>>>>>> WOCrashProtector Start<<<<<<<<<<<<<<<<<<<<<<<<";

static const NSString *WOCrashSeparatorWithFlagEnd = @">>>>>>>>>>>>>>>>>>>>>>>> WOCrashProtector End<<<<<<<<<<<<<<<<<<<<<<<<";
...
+ (void)wo_noteErrorWithException:(NSException *)exception attachedTODO:(NSString *)todo {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n%@\n%@\n%@\n%@\n%@\n%@\n\n",WOCrashSeparatorWithFlagStart, crashType, errorReason, errorPlace, crashProtector, exception.callStackSymbols,WOCrashSeparatorWithFlagEnd];
